...
import peoplegroup from "../../Project_gpt3/Group 81.png";
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center md:items-start relative z-0">
      <div className="md:max-w-md md:ml-10 md:text-left">
        <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-red-500 to-violet-500 text-transparent bg-clip-text mb-6 md:mb-8 px-6 md:px-0">
        ...
        <div className="flex flex-col md:flex-row items-center md:max-w-md px-6 md:px-0">
          <input className="w-full md:w-64 py-3 px-4 rounded-l-lg rounded-r-none mb-4 md:mb-0 md:mr-2" type="text" />
      ...
      <img className="w-full md:w-96 md:mt-6 md:-ml-20 z-10" src={headimg} alt="" />
    </div>
  );
}
